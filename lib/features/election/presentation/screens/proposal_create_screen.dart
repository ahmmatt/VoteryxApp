  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('Ajukan Pemilihan Baru', style: AppTypography.headerTitle),
      ),
      body: Column(
        children: [
          _buildStepIndicator(),
  ...
  Widget _buildCandidateFormCard({
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.circular(12),
        border: Border.all(color: isDashed ? AppColors.outlineVariant : (isError ? const Color(0xFFE53935).withOpacity(0.3) : AppColors.outlineVariant.withOpacity(0.3))),
      ),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
