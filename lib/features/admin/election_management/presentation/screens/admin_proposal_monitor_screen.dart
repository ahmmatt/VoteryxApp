      ...
      child: Column(
        ...
        children: [
              ...
              children: [
                Container(
                    ...
                    decoration: const BoxDecoration(
                        color: AppColors.goldMid, shape: BoxShape.circle)),
          ...
          Text('Pemilihan Ketua HIMA TI 2026',
              style: AppTypography.displayHeading
                  .copyWith(fontSize: 20, color: AppColors.primary900)),
          ...
          Row(
            children: [
              ...
              const SizedBox(width: 6),
              Text('Diajukan pada 14 Okt 2025',
          ...
          SizedBox(
            ...
            child: ElevatedButton(
              onPressed: () {
                context.pushNamed('admin-proposal-track',
                    pathParameters: {'id': 'VTX-7777'});
              },
      ...
      children: [
        ...
        Row(
          ...
          children: [
            Text('Diajukan',
                style: AppTypography.captionBold
                    .copyWith(color: AppColors.successTeal, fontSize: 10)),
            Text('Review Admin',
                style: AppTypography.captionBold
                    .copyWith(color: AppColors.goldMid, fontSize: 10)),
            Text('Disetujui',
                style: AppTypography.caption
  ...
  Widget _buildTimelineNode({required bool isActive, required bool isCurrent}) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: isCurrent
            ? Border.all(color: AppColors.goldMid.withOpacity(0.3), width: 4)
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  borderRadius: BorderRadius.circular(16),
                  border:
                      Border.all(color: AppColors.successTeal.withOpacity(0.3)),
                ),
                child: Row(
                  mainAxisSize: MainAxisSize.min,
                  children: [
                    const Icon(Icons.check_circle,
                        color: AppColors.successTeal, size: 14),
                    const SizedBox(width: 6),
                    Text('Disetujui',
                        style: AppTypography.captionBold
          ...
          const SizedBox(height: 12),
          Text('Pemilihan Ketua BEM FE 2026',
              style: AppTypography.displayHeading
                  .copyWith(fontSize: 20, color: AppColors.primary900)),
          const SizedBox(height: 16),
          ...
          SizedBox(
            ...
            child: OutlinedButton(
              onPressed: () {
                context.pushNamed('admin-proposal-candidates',
                    pathParameters: {'id': 'VTX-8821'});
              },
